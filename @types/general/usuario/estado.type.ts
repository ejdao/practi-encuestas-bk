...
const INACTIVO = new EstadoUsuarioType(1, 'INACTIVO');
const ACTIVO = new EstadoUsuarioType(2, 'ACTIVO');
...
export const ESTADO_USUARIO = { INACTIVO, ACTIVO, SUSPENDIDO, RETIRADO, ACCESO_BLOQUEADO };

export const ESTADO_USUARIO_VALUES = [INACTIVO, ACTIVO, SUSPENDIDO, RETIRADO, ACCESO_BLOQUEADO];
