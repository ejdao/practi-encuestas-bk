...
import { MunicipioCrudSource } from '@srd/ubicacion/infrastructure/repositories';
import { MunicipioRes } from '@srd/ubicacion/application/responses';

@ApiTags('V1 | Ubicación')
@Controller('v1/srd/ubicacion/municipios')
